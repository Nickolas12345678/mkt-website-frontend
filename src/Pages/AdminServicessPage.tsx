...
const AdminServicesPage = () => {
    ...
    const fetchServices = async () => {
        try {
            const response = await axios.get("https://mkt-uzhhorod-f075ee5ee8b4.herokuapp.com/api/services");
        ...
        try {
            if (serviceData.id) {
                const response = await axios.put(
                    `https://mkt-uzhhorod-f075ee5ee8b4.herokuapp.com/api/services/${serviceData.id}`,
                    serviceData,
                ...
                const response = await axios.post(
                    "https://mkt-uzhhorod-f075ee5ee8b4.herokuapp.com/api/services",
                    {
    ...
    const deleteService = async (id: number, title: string) => {
        ...
        try {
            const token = localStorage.getItem("jwt");
            await axios.delete(`https://mkt-uzhhorod-f075ee5ee8b4.herokuapp.com/api/services/${id}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white p-6 rounded-lg shadow-xl w-96">
                        <h2 className="text-xl font-bold mb-4 text-center text-gray-800">
                            {serviceData.id ? "Редагувати послугу" : "Додати послугу"}
                        </h2>
                        <input
                            type="text"
                            placeholder="Назва"
